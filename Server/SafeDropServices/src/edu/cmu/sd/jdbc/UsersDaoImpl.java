...
calls to this DAO, otherwise a new Connection will be allocated for each operation.
	 ...
	 */
	protected final String SQL_SELECT = "SELECT email, firstname, lastname, mobile, econtact, ename, status, username, lastactive, lastlat, lastlong, zip FROM " + getTableName() + "";
	 ...
	 */
	protected final String SQL_INSERT = "INSERT INTO " + getTableName() + " ( email, firstname, lastname, mobile, econtact, ename, status, username, lastactive, lastlat, lastlong, zip ) VALUES ( ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ? )";

	/** 
	 * SQL UPDATE statement for this table
	 */
	protected final String SQL_UPDATE = "UPDATE " + getTableName() + " SET email = ?, firstname = ?, lastname = ?, mobile = ?, econtact = ?, ename = ?, status = ?, username = ?, lastactive = ?, lastlat = ?, lastlong = ?, zip = ? WHERE email = ?";
	 ...
	 * Index of column zip
	 */
	protected static final int COLUMN_ZIP = 12;
